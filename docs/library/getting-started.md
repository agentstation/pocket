# Getting Started with Pocket Go Library
...
3. **Post**: Write state, determine next node
...
1. **Explore Type Safety**: Learn about Pocket's [type system](../guides/TYPE_SAFETY.md)
2. **Master State Management**: Understand [stores and scoping](../guides/STATE_MANAGEMENT.md)
3. **Build Resilient Workflows**: Study [error handling patterns](../guides/ERROR_HANDLING.md)
4. **Learn Patterns**: Check out [concurrency patterns](../patterns/CONCURRENCY.md)
5. **See Examples**: Browse the [example projects](../../examples/)
