// Package yaml provides YAML-based workflow definition and loading capabilities,
// enabling configuration-driven graph construction.
package yaml
...
func (l *Loader) LoadDefinition(def *GraphDefinition, store pocket.Store) (*pocket.Graph, error) {
	...
	startNode, exists := nodes[def.Start]
	if !exists {
